...
export type RoadmapInfoFieldsFragment = {
  id: number;
  title: string;
  description: string;
  createdAt: Date;
...
export type ToggleFollowRoadmapMutation = {
  toggleFollowRoadmap: { id: number; followers: Array<{ id: number }> };
};
...
export type UpdateCheckpointStatusMutation = {
  updateCheckpointStatus: { id: number; status?: Maybe<Status> };
};
...
export type RoadmapQuery = {
  roadmap: {
    checkpoints: Array<{
      ...
      instructions: string;
      status?: Maybe<Status>;
      links: Array<LinkFieldsFragment>;
    }>;
...
export type UserQuery = {
  user: {
    followingRoadmaps: Array<RoadmapInfoFieldsFragment>;
    createdRoadmaps: Array<RoadmapInfoFieldsFragment>;
